            ...
            <div className='container mx-auto flex justify-between items-center h-screen'>
                <div className='w-[40%] '>
                    <form onSubmit={handleRegistration} >
                        ...
                        <button className='w-full p-2 px-2 py-2 transform active:scale-[1.09] transition-[.4s]  outline-none my-1  border border-blue-600 rounded-lg bg-green-600 font-bold text-gray-50'> Login</button>
                    </form>
                    <p className='text-center text-green-800 text-3xl font-bold my-2 '>I have  an account? <Link to='/registration' className='text-blue-600 ' > Registration</Link> </p>
                </div>
